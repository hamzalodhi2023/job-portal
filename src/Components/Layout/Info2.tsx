...
function Info2() {
  return (
    <div className="w-full py-15 px-18 flex lg:flex-row items-center justify-center flex-col gap-16">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center flex-col gap-10">
        ...
        <div className="w-full flex items-center justify-start gap-10">
          ...
          <div className="flex items-center justify-center flex-col gap-8">
            <div className="w-full flex items-center justify-start gap-4 px-7.75 py-5.75">
