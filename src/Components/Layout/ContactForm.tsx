...
function ContactInfo() {
  ...
  return (
    <div className="w-full py-15 px-5 lg:px-18 flex items-center justify-between gap-4">
      <div className="w-full max-w-3xl px-6 lg:px-10 py-10 lg:py-15 bg-primary/10 rounded-[20px]">
        <Heading
      ...
      <div className="w-full h-fit">
        <iframe
          className="w-full h-151.75 lg:h-161.75 rounded-[20px]"
          height="900px"
